...
public class front_land extends AppCompatActivity {
    ...
    int swic,range_counter = 0,oldover = -1, currover;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_front_land);

        init();

        getdatafromFirebase();
        //Todo: Notification call
//          Intent i = new Intent(front_land.this,NotifService.class);
//          front_land.this.startService(i);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //FancyToast.makeText(front_land.this,"Animation mode is under maintenance, please try again later!",FancyToast.LENGTH_LONG,FancyToast.WARNING,false).show();
                Intent intent = new Intent(front_land.this, stat_activity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.putExtra("matchid", matchid);
                startActivity(intent);

                /**Intent intent = new Intent(front_land.this, isworking.class);
                 startActivity(intent);**/
    ...
    public void onBackPressed() {
        startActivity(new Intent(front_land.this, MainActivity.class));
    }
                    ...
                    switch (item.getItemId()) {
                        ...
                        case R.id.navigation_news:
                            if(fuser != null){
                                ...
                                Intent intent = new Intent(front_land.this, Login.class);
                                intent.putExtra("matchid", matchid);
                                startActivity(intent);
                            }
                        ...
                        /**case R.id.navigation_settings:
                            ...
                            return true;**/
                        case R.id.navigation_trajectory:
                            Intent intent = new Intent(front_land.this, stat_activity.class);
                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            intent.putExtra("matchid", matchid);
                            startActivity(intent);
                        ...
                        case R.id.navigation_ar:
                            FancyToast.makeText(front_land.this,"Coming soon",FancyToast.LENGTH_LONG,FancyToast.CONFUSING,false).show();
//                            if(ContextCompat.checkSelfPermission(front_land.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_DENIED) {
//                                ActivityCompat.requestPermissions(front_land.this,new String[] {Manifest.permission.CAMERA},1000);
//                            }
//                            if(ContextCompat.checkSelfPermission(front_land.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
//                                startActivity(new Intent(front_land.this,arActivity.class));
//                            }
            ...
            public void run() {
                ...
                myRef3.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull final DataSnapshot dataSnapshotx) {
                        //long lon = dataSnapshotx.getChildrenCount();

                        //@NonNull final DataSnapshot dataSnapshotx = dataSnapshotxv;
                        try{
                        ...
                        for (DataSnapshot child : dataSnapshotx.child("balls").child("0").child("comments").getChildren()) {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot2) {
                                        for (DataSnapshot child : dataSnapshot2.getChildren()) {
                                            if (child.child("playerId").getValue().toString().equals(offstrikebatid)) {
                                                ...
                                                front_land.this.runOnUiThread(new Runnable() {
                                                    @Override
                                                    public void run() {
                                                        try{
                                                            ...
                                                            Glide.with(front_land.this).load(bowlerurl).into(iv_pff);
                                                            ImageView b1p,b2p;
                                                            b1p = findViewById(R.id.iv_topbt1);
                                                            b2p = findViewById(R.id.iv_topbt2);
                                                            Glide.with(front_land.this).load(b1url).into(b2p);
                                                            Glide.with(front_land.this).load(b2url).into(b1p);
                                                        }catch (Exception e){
                                                        ...
                                                        myRef4.addListenerForSingleValueEvent(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                try{
                                                                    ...
                                                                    System.out.println("No commentary received");
                                                                }
                                                                    ...
                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                        ...
                                                                        for(int l = 0; l<ll;l++){
                                                                            if(l>=commenballov.length){
                                                                                ...
                                                                                bList.add(0,new overballdata(l,commenballov[l]));
                                                                            }
                                                                        ...
                                                                        final Bat_adapter bat_adapter = new Bat_adapter(front_land.this, barrayList);
                                                                        final int s = size;
                                                                        final int s2 = size2;
                                                                        front_land.this.runOnUiThread(new Runnable() {
                                                                            @Override
                                                                            public void run() {
                                                                                ...
                                                                                ListView lv = findViewById(R.id.ls_bat);
                                                                                lv.setAdapter(bat_adapter);
                                                                                RecyclerView rv = findViewById(R.id.rv_col);
                                                                                rv.setHasFixedSize(true);
                                                                                rv.setLayoutManager(new GridLayoutManager(front_land.this, s, RecyclerView.VERTICAL, false));
                                                                                rv.setAdapter(cadapter);

                                                                                RecyclerView rv_eb = findViewById(R.id.rv_eachball);
                                                                                rv_eb.setHasFixedSize(true);
                                                                                rv_eb.setLayoutManager(new GridLayoutManager(front_land.this, s2, RecyclerView.VERTICAL, false));
                           ...
                           // }
                        }catch (final Exception crash){
                            front_land.this.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    AlertDialog alertDialog = new AlertDialog.Builder(front_land.this).create();
                                    alertDialog.setTitle("Server Error");
                                    alertDialog.setMessage("Please try again " + crash.toString());
    ...
    public void updatecommen(){
        ...
        t1 = new TextToSpeech(front_land.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        Commenadapter commenadapter = new Commenadapter(front_land.this, arrayList,t1);
    ...
    public void predict_over(int allow){
        ...
        ImageButton runup = findViewById(R.id.bt_runup);
        ImageButton rundwn = findViewById(R.id.bt_rundwn);
        ImageButton wup = findViewById(R.id.bt_wup);
        ImageButton wdwn = findViewById(R.id.bt_wdwn);
        Button op_submit = findViewById(R.id.bt_osub);
        TextView tv_optit = findViewById(R.id.tv_optit);
        final TextView et_run = findViewById(R.id.et_r);
        final EditText et_w = findViewById(R.id.et_w);
        ...
        runup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(range_counter<range.length-1){
                    ...
                    FancyToast.makeText(front_land.this,"This is the highest range",FancyToast.LENGTH_LONG,FancyToast.ERROR,false).show();
                }
            }
        });
        ...
        rundwn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(range_counter>0){
                    ...
                    FancyToast.makeText(front_land.this,"This is the lowest range",FancyToast.LENGTH_LONG,FancyToast.ERROR,false).show();
                }
            }
        });
        ...
        wup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(data.equals(" ")||data.isEmpty()||wickets<0){
                    FancyToast.makeText(front_land.this,"Enter valid data",FancyToast.LENGTH_LONG,FancyToast.ERROR,false).show();
                }else {
                    wickets++;
        ...
        wdwn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int wickets = Integer.parseInt(data);
                if(data.equals(" ")||data.isEmpty()||wickets<=0){
                    FancyToast.makeText(front_land.this,"Cannot reduce further. Enter valid wickets",FancyToast.LENGTH_LONG,FancyToast.ERROR,false).show();
                }else {
                    wickets--;
                    et_w.setText(String.valueOf(wickets));
                }
        ...
        op_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(currover == 20){
                    FancyToast.makeText(front_land.this,"Predictions over for current match",FancyToast.LENGTH_LONG,FancyToast.ERROR,false).show();
                    pred.setVisibility(View.GONE);
                    pred.setEnabled(false);
                }
//                else if(oldover <= currover) {
//                    FancyToast.makeText(front_land.this,"Predictions over for current over",FancyToast.LENGTH_LONG,FancyToast.ERROR,false).show();
//                    pred.setVisibility(View.GONE);
//                    pred.setEnabled(false);
//                }
                else{
    ...
    public void sendPredictionRequest(int p1, int p2){
        if(fuser == null){
            ...
            try{
                ...
                FancyToast.makeText(front_land.this,"Predictions submitted! Results will be out after the match!",FancyToast.LENGTH_LONG,FancyToast.SUCCESS,false).show();
                pred.setVisibility(View.GONE);
                pred.setEnabled(false);
            }catch(Exception pe){
                FancyToast.makeText(front_land.this,"Please try again",FancyToast.LENGTH_LONG,FancyToast.ERROR,false).show();
    ...
    public void init(){
        ...
        c1_flag = findViewById(R.id.flag1);
        pred = findViewById(R.id.lin_guess_over);
        c2_flag = findViewById(R.id.flag2);
        c1_title = findViewById(R.id.c1_name);
        c2_title = findViewById(R.id.c2_name);
        btn_hide = findViewById(R.id.ibtn_hide);
        tv_cbs = findViewById(R.id.tv_cbs);
        tv_cov = findViewById(R.id.tv_cov);
        tv_currbat = findViewById(R.id.tv_curbat);
        tv_onstrike = findViewById(R.id.tv_onstrike_tag);
        tv_offstrike = findViewById(R.id.tv_offstrike_tag);
        ...
        iv_pff = findViewById(R.id.iv_frontplayer);
        fm_holder.setVisibility(View.GONE);
        rel_nstat.setVisibility(View.VISIBLE);

        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(front_land.this);
        ...
        if (!shield.equals("null")) {
            Glide.with(front_land.this).load(shield).into(iv_shield);
        }
        Glide.with(front_land.this).load(teamlogourl[0]).into(c1_flag);
        Glide.with(front_land.this).load(teamlogourl[1]).into(c2_flag);
